    ...
    <div class="mx-20 py-16 grid grid-cols-2 gap-10">
        ...
        <div>
            <form action="actioncart.php" method="POST">
                ...
                <input name="quantity" class="border p-2" type="number" min="1" max="<?php echo $row['stock'];?>" value="1" required> <br><br>
                <button type="submit" name="cart" class="bg-red-500 text-white px-4 py-2 rounded"><i class="ri-shopping-cart-fill"></i> Add to Cart</button>
            </form>
        </div>
